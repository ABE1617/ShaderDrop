      ...
      <section className="space-y-4">
        <div className="rounded-xl bg-white/[0.02] border border-white/[0.06] p-5">
          <div className="flex items-start gap-4">
            <div className="w-8 h-8 rounded-lg bg-purple-500/20 flex items-center justify-center flex-shrink-0 text-sm font-bold text-purple-400">
              1
            </div>
            <div>
              <h3 className="font-medium mb-1 text-white">Pick a shader</h3>
              ...
              >
                View shaders <ArrowRight className="h-3.5 w-3.5" />
              </Link>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-xl bg-white/[0.02] border border-white/[0.06] p-5">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="font-medium mb-1 text-white">Download or copy</h3>
              <p className="text-sm text-white/50">
                Click <Download className="inline h-3.5 w-3.5" /> to download the .tsx file, or copy the code directly.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-xl bg-white/[0.02] border border-white/[0.06] p-5">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="font-medium mb-1 text-white">Add to your project</h3>
...
export default function Page() {
  return (
    <div className="relative min-h-screen">
      ...
      <section className="space-y-4">
        ...
        <div className="grid sm:grid-cols-2 gap-3">
          <div className="rounded-xl bg-white/[0.02] border border-white/[0.06] p-4">
            <h3 className="font-medium mb-2 text-sm text-white">Framework</h3>
          ...
          <div className="rounded-xl bg-white/[0.02] border border-white/[0.06] p-4">
            <h3 className="font-medium mb-2 text-sm text-white">Browser</h3>
            <ul className="space-y-1.5 text-sm text-white/50">
              <li className="flex items-center gap-2">
                <span className="w-1.5 h-1.5 rounded-full bg-green-500" />
      ...
      {/* License */}
      <section className="rounded-xl bg-white/[0.02] border border-white/[0.06] p-4">
        <p className="text-sm text-white/50">
